...
var Sector3DLabelLine = echarts.graphic.extendShape({
 ...
 * 
 */
var Sector3DBottom = echarts.graphic.extendShape({
 ...
 * 
 */
var Sector3DTop = echarts.graphic.extendShape({
 ...
 * 绘制3D扇形内侧面1
 */
var Sector3DSideInnerLeft = echarts.graphic.extendShape({
 ...
 * 绘制3D扇形内侧面2
 */
var Sector3DSideInnerRight = echarts.graphic.extendShape({
 ...
 * 绘制3D扇形外侧面
 */
var Sector3DSideOutter = echarts.graphic.extendShape({
    ...
    buildPath: function (ctx, shape) {     
        ...
        //     }else if(e>PI){
        //         // e = PI;
        //         return [{s:s,e:PI,f:f},{s:PI,e:e,f:f}];
        //     }
        //     return {s:s,e:e,f:f};
        // };
...
module.exports = {
    Sector3DBottom: Sector3DBottom,
    Sector3DTop: Sector3DTop,
    Sector3DSideInnerLeft: Sector3DSideInnerLeft,
    Sector3DSideInnerRight: Sector3DSideInnerRight,
    Sector3DSideOutter: Sector3DSideOutter,
    Sector3DLabelLine: Sector3DLabelLine
}